(function(){
    'use strict';
    function SkillTree($http, $q, CONFIG, XML2JSON, pouchDB, lodash){
    ...
    angular
        .module('compendium.skilltree')
            .service('SkillTree', ['$http', '$q', 'CONFIG', 'XML2JSON', 'pouchDB', 'lodash', SkillTree]);
})();
